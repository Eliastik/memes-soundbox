        ...
        <>
            ...
            <div className="modal">
                <div className="modal-box">
                    ...
                    <form method="dialog">
                        <button className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2" onClick={() => closeErrorLoading()}>✕</button>
                    </form>
                    <div className="flex flex-col">
                        <div className="mt-3">
                            <p className="py-4 flex items-center gap-x-4">
                                ...
                                {!initialLoadingFinished && <span className="shrink">{t("dialogs.loadingError.info")}</span>}
                                {initialLoadingFinished && <span className="shrink">{t("dialogs.loadingError.minorInfo")}</span>}
                            </p>
                        </div>
                    </div>
