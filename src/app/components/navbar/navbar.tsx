            ...
            <div className="navbar bg-primary text-white fixed z-40">
                <div className="flex-1">
                    <details className="dropdown max-h-12">
                        <summary className="btn btn-ghost text-white normal-case sm:text-xl text-base text-left overflow-hidden md:pl-2 md:pr-2 pl-1 pr-1 border-none">
                ...
                <div className="flex-none">
                    <button className="btn btn-square btn-ghost text-white" onClick={() => (document.getElementById("modalSettings")! as HTMLDialogElement).showModal()}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    ...
                    <button className="btn btn-square btn-ghost text-white" onClick={() => (document.getElementById("modalInfos")! as HTMLDialogElement).showModal()}>
