        ...
        <>
            {currentSound && allSounds.length > 0 && (
                <div className="flex flex-row justify-center items-center w-full">
                    <label htmlFor="selectSound" className="flex flex-row justify-center items-center mr-4 text-xs md:text-md">
                    ...
                    <select
                        className="select select-bordered sm:w-96 w-64 h-10 min-h-10 md:h-12 md:min-h-12 text-xs md:text-md"
